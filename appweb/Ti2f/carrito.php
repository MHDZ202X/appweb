...
<body>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="eliminaModalLabel">Atencion</h5>
                ...
                <div class="modal-footer">
                    ...
                    <button id="btn-elimina" type="button" class="btn btn-danger" onclick="eliminar()">Aceptar</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function actualizaCantidad(cantidad, id) {
            let url = 'php/carritoActualizar.php';
